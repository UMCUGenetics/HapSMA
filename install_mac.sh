...
java_download_url='https://download.java.net/java/GA/jdk21.0.2/f2283984656d49d69e91c558476027ac/13/GPL/openjdk-21.0.2_macos-aarch64_bin.tar.gz'
...
chmod +x ${repo_dir}/tools/java/jdk/Contents/Home/bin/java

${repo_dir}//tools/java/jdk/Contents/Home/bin/java -version

echo "OpenJDK ${java_base} installed to ${repo_dir}/tools/java/jdk/Contents/Home"

echo "Downloading and installing Nextflow"

cd ${repo_dir}/tools/nextflow

export NXF_JAVA_HOME=${repo_dir}'/tools/java/jdk/Contents/Home'
...
chmod +xr ${repo_dir}/tools/nextflow/nextflow
